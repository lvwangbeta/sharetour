			    ...
			    <div class="tab-pane active" id="avatars">
			      ...
			      %>
			      	<div class="avator">
			      		<span>
			      		<a href="#">
	                    <img class="" src="<%=request.getContextPath()%>/imgs?id=<%=avatorService.getAvatorOfUser(p.getId()).getAvatorId() %>&coll=avator_thumb" style="width: 64px; height: 64px;">
			      		</a>
			      		</span>
			      		<span>
              ...
              <div class="tab-pane active" id="weekhotposts">
                ...
                <div class="media">
                  <a class="pull-left" href="<%=request.getContextPath()%>/post/<%=wp.getId() %>">
                    ...
                    src="<%=request.getContextPath()%>/imgs?id=<%=avatorService.getAvatorOfUser(wp.getAuthorid()).getAvatorId().toString() %>&coll=avator_thumb" 
